...
function webbiecorn_starter_scripts() {
    ...
    // =========================================================================
    // CSS - Bundled (core styles)
    // =========================================================================
    // ⚡ Bolt: Concatenated core CSS files into a single bundle to reduce
    // the number of render-blocking HTTP requests from 7 to 1.
    // Run ./assets/build-css.sh to rebuild this file.
    ...
    wp_enqueue_style(
        ...
        get_stylesheet_uri(),
        array('wc-bundle'), // Depends on the bundle now
        $version
    );
